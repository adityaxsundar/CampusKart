...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#030a0d]/60 backdrop-blur-xl border-t border-teal-900/30 mt-20 py-10 flex flex-col items-center justify-center text-teal-100/40 text-sm space-y-4">
      <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-center">
        <p className="font-black text-teal-100 uppercase tracking-[0.2em] text-[10px] opacity-80">
          Developed by
          <span className="text-teal-400 ml-2">Daksh & Team</span>
        </p>
